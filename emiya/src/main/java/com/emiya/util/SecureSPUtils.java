...
public class SecureSPUtils implements SharedPreferences {
    ...
    private static final String TAG = SecureSPUtils.class.getName();
     ...
     */
    public SecureSPUtils(Context context, int iterationCount) {
     ...
     */
    public SecureSPUtils(Context context, final String password, final String sharedPrefFilename) {
     ...
     * @param iterationCount The iteration count for the keys generation
     */
    public SecureSPUtils(Context context, final String password, final String sharedPrefFilename, int iterationCount) {
     ...
     * @param sharedPrefFilename name of the shared pref file. If null use the default shared prefs
     */
    public SecureSPUtils(Context context, final AesCbcWithIntegrity.SecretKeys secretKey, final String sharedPrefFilename) {
        this(context, secretKey, null, sharedPrefFilename, 0);
    }

    private SecureSPUtils(Context context, final AesCbcWithIntegrity.SecretKeys secretKey, final String password, final String sharedPrefFilename, int iterationCount) {
    ...
    public String getString(String key, String defaultValue) {
        final String encryptedValue = sharedPreferences.getString(
                SecureSPUtils.hashPrefKey(key), null);
    ...
    public boolean contains(String key) {
        return sharedPreferences.contains(SecureSPUtils.hashPrefKey(key));
    }
     ...
     * <p>
     * Used for modifying values in a {@link SecureSPUtils} object. All
     * changes you make in an editor are batched, and not copied back to the
     * original {@link SecureSPUtils} until you call {@link #commit()} or
     * {@link #apply()}.
     */
    public final class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putString(String key, String value) {
            mEditor.putString(SecureSPUtils.hashPrefKey(key),
                    encrypt(value));
            return this;
        }
        ...
        public SharedPreferences.Editor putUnencryptedString(String key,
                                                             String value) {
            mEditor.putString(SecureSPUtils.hashPrefKey(key), value);
            return this;
        }
        ...
        public SharedPreferences.Editor putStringSet(String key,
            ...
            mEditor.putStringSet(SecureSPUtils.hashPrefKey(key),
                    encryptedValues);
            return this;
        }
        ...
        public SharedPreferences.Editor remove(String key) {
            mEditor.remove(SecureSPUtils.hashPrefKey(key));
            return this;
        }
